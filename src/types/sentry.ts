...
// ─────────────────────────────────────────────────────────────────────────────
// Issue Summary (AI-generated analysis)
// ─────────────────────────────────────────────────────────────────────────────

/**
 * Scores from the AI analysis indicating confidence and fixability.
 */
export const IssueSummaryScoresSchema = z
  .object({
    possibleCauseConfidence: z.number().nullable(),
    possibleCauseNovelty: z.number().nullable(),
    isFixable: z.boolean().nullable(),
    fixabilityScore: z.number().nullable(),
    fixabilityScoreVersion: z.string().nullable(),
  })
  .passthrough();

/**
 * AI-generated summary of an issue from the /summarize/ endpoint.
 */
export const IssueSummarySchema = z
  .object({
    ...
    /** Confidence and fixability scores */
    scores: IssueSummaryScoresSchema.optional(),
...
export type IssueSummaryScores = z.infer<typeof IssueSummaryScoresSchema>;
