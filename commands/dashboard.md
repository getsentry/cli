...
url: "https://cli.sentry.dev/commands/dashboard/"
---
...
- [Previous: dart-symbol-map](https://cli.sentry.dev/commands/dart-symbol-map.md)
- [Next: debug-files](https://cli.sentry.dev/commands/debug-files.md)
