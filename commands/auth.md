...
url: "https://cli.sentry.dev/commands/auth/"
---
...
See [Self-Hosted Sentry](https://cli.sentry.dev/commands/self-hosted.md) for details.
...
- [Previous: api](https://cli.sentry.dev/commands/api.md)
- [Next: build](https://cli.sentry.dev/commands/build.md)
