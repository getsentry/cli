...
url: "https://cli.sentry.dev/migrating-from-v3/"
---
...
| Exit codes | mostly `1` | [semantic ranges](https://cli.sentry.dev/exit-codes.md) (auth=1x, input=2x, API=3x…) |
...
- [Previous: Installation](https://cli.sentry.dev/getting-started.md)
- [Next: Self-Hosted](https://cli.sentry.dev/self-hosted.md)
