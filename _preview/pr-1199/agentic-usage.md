...
url: "https://cli.sentry.dev/_preview/pr-1199/agentic-usage/"
---

# Agentic Usage

AI coding agents like Claude Code, OpenCode — and any agent that reads skills from `~/.agents` (such as Cursor) — can use the Sentry CLI through the skill system. This allows agents to interact with Sentry directly from your development environment.
...
- An AI coding agent that supports the skills system (e.g., Claude Code, OpenCode, or any agent that reads from `~/.agents` such as Cursor)
