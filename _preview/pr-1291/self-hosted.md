...
url: "https://cli.sentry.dev/_preview/pr-1291/self-hosted/"
---
...
See [Configuration](https://cli.sentry.dev/_preview/pr-1291/self-hosted/configuration.md) for the full environment variable reference.

## Navigation

- [Docs home](https://cli.sentry.dev/_preview/pr-1291/index.md)
- [Previous: Migrating from v3](https://cli.sentry.dev/_preview/pr-1291/migrating-from-v3.md)
- [Next: Configuration](https://cli.sentry.dev/_preview/pr-1291/configuration.md)
