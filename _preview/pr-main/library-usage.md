...
- [Previous: Configuration](https://cli.sentry.dev/_preview/pr-main/configuration.md)
- [Next: Agentic Usage](https://cli.sentry.dev/_preview/pr-main/agentic-usage.md)
