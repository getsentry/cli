...
url: "https://cli.sentry.dev/_preview/pr-1229/"
---
...
<InstallSelector options={[
  ...
  { label: "yarn", command: "yarn global add sentry" },
  { label: "bun", command: "bun add -g sentry" }
]} />
[Or read the documentation.](https://cli.sentry.dev/_preview/pr-1229/getting-started.md)
...
- [Installation](https://cli.sentry.dev/_preview/pr-1229/getting-started.md)
- [Self-Hosted](https://cli.sentry.dev/_preview/pr-1229/self-hosted.md)
- [Configuration](https://cli.sentry.dev/_preview/pr-1229/configuration.md)
- [Library Usage](https://cli.sentry.dev/_preview/pr-1229/library-usage.md)
- [Agentic Usage](https://cli.sentry.dev/_preview/pr-1229/agentic-usage.md)
- [Contributing](https://cli.sentry.dev/_preview/pr-1229/contributing.md)
- [Agent Guidance](https://cli.sentry.dev/_preview/pr-1229/agent-guidance.md)
- [Commands](https://cli.sentry.dev/_preview/pr-1229/commands.md)
- [Exit Codes](https://cli.sentry.dev/_preview/pr-1229/exit-codes.md)
- [Features](https://cli.sentry.dev/_preview/pr-1229/features.md)
