...
url: "https://cli.sentry.dev/_preview/pr-1343/self-hosted/"
---
...
See [Configuration](https://cli.sentry.dev/_preview/pr-1343/self-hosted/configuration.md) for the full environment variable reference.

## Navigation

- [Docs home](https://cli.sentry.dev/_preview/pr-1343/index.md)
- [Previous: Migrating from v3](https://cli.sentry.dev/_preview/pr-1343/migrating-from-v3.md)
- [Next: Configuration](https://cli.sentry.dev/_preview/pr-1343/configuration.md)
