...
url: "https://cli.sentry.dev/_preview/pr-1298/self-hosted/"
---
...
See [Configuration](https://cli.sentry.dev/_preview/pr-1298/self-hosted/configuration.md) for the full environment variable reference.

## Navigation

- [Docs home](https://cli.sentry.dev/_preview/pr-1298/index.md)
- [Previous: Migrating from v3](https://cli.sentry.dev/_preview/pr-1298/migrating-from-v3.md)
- [Next: Configuration](https://cli.sentry.dev/_preview/pr-1298/configuration.md)
