...
url: "https://cli.sentry.dev/self-hosted/"
---
...
See [Configuration](https://cli.sentry.dev/self-hosted/configuration.md) for the full environment variable reference.

## Navigation

- [Docs home](https://cli.sentry.dev/index.md)
- [Previous: Migrating from v3](https://cli.sentry.dev/migrating-from-v3.md)
- [Next: Configuration](https://cli.sentry.dev/configuration.md)
